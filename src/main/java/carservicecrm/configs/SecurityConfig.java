    ...
    protected SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests((requests) -> requests
                        .requestMatchers("/", "/offer/**", "/images/**", "/registration", "/static/**", "/error", "user/reviews", "/logo").permitAll()
                        ...
                        .requestMatchers("/manufacturer/**")
                        .hasAnyAuthority("ROLE_ADMIN", "ROLE_MANUFACTURER")
